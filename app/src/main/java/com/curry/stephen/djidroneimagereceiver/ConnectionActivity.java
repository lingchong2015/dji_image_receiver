...
public class ConnectionActivity extends Activity implements View.OnClickListener {
    ...
    private void refreshSDKRelativeUI() {
        ...
        if (null != mProduct && mProduct.isConnected()) {
            ...
            String str = mProduct instanceof Aircraft ? "大疆无人机" : "大疆手柄";
            mTextConnectionStatus.setText("状态：" + str + "连接");

            if (null != mProduct.getModel()) {
                mTextProduct.setText("产品：" + mProduct.getModel().getDisplayName());
            } else {
                mTextProduct.setText("产品：无信息");
            }
            ...
            mTextProduct.setText("产品：无信息");
            mTextConnectionStatus.setText("状态：无产品连接");
        }
    }
