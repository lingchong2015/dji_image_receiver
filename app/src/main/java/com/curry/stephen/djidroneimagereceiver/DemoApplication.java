...
public class DemoApplication extends Application{
    ...
    public void onCreate() {
            ...
            public void onRegister(DJIError error) {
                ...
                if(error == DJISDKError.REGISTRATION_SUCCESS) {
                    ...
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), "SDK注册成功！", Toast.LENGTH_LONG).show();
                        }
                    });
                    ...
                    handler.post(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), "SDK注册失败，请检查网络连接。", Toast.LENGTH_LONG).show();
                        }
                    });
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M || (permissionCheck == 0 && permissionCheck2 == 0)) {
            ...
            Toast.makeText(getApplicationContext(), "正在注册，请稍候...", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(getApplicationContext(), "请检查未授予的权限后再尝试！", Toast.LENGTH_LONG).show();
        }
    }
